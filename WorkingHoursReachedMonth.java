public class WorkingHoursReachedMonth
{
   public static final int fullTime=1;
   public static final int partTime=2;
   public static final int totalWorkingDays=20;

	public void WagesUptoMonth()
   {
      int wagePerHour=20;
      ...
      System.out.println("Total working hours of employee" +totalWorkingHours);
      System.out.println("Total wage of employee" +totalwage);
   }
   public static void main (String[] args)
	{
		WorkingHoursReachedMonth whrm=new WorkingHoursReachedMonth();
		whrm.WagesUptoMonth();
	}
}
